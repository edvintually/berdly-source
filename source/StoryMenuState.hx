...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		scoreText.setFormat("Determination Mono Web Regular", 32);

		txtWeekTitle = new FlxText(FlxG.width * 0.7, 10, 0, "", 32);
		txtWeekTitle.setFormat("Monster Friend 2 Back", 32, FlxColor.WHITE, RIGHT);
		txtWeekTitle.alpha = 0.7;

		var rankText:FlxText = new FlxText(0, 10);
		rankText.text = 'RANK: GREAT';
		rankText.setFormat("Determination Mono Web Regular", 32);
	...
	function weekIsLocked(weekNum:Int) {
		var leWeek:WeekFile = WeekData.weeksLoaded.get(WeekData.weeksList[weekNum]);
