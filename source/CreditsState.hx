...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Mod Authors'],
		['Edvin',				'ebin',				'i dont really know what i did',					'https://twitter.com/edvintually',		0xFF9269D3],
		['Jerm',				'jerm',				'made the music like holy its epic',				'https://twitter.com/PinkOvine',		0xFF231B35],
		[''],
		['Psych Engine Team'],
	...
	override function create()
	{
		...
		descText.setFormat(Paths.font("determination.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
